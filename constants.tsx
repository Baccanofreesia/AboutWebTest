...
export const Icons: Record<string, React.FC<{ className?: string }>> = {
  ...
  Music: ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m9 9 10.5-3m0 6.553v3.75a2.25 2.25 0 0 1-1.632 2.163l-1.32.377a1.803 1.803 0 1 1-.99-3.467l2.31-.66a2.25 2.25 0 0 0 1.632-2.163Zm0 0V4.103A2.25 2.25 0 0 0 17.291 2.04l-7.2 2.057A2.25 2.25 0 0 0 8.46 6.26v6.547m0 0v3.75a2.25 2.25 0 0 1-1.632 2.163l-1.32.377a1.803 1.803 0 0 1-.99-3.467l2.31-.66A2.25 2.25 0 0 0 8.46 12.81Z" />
    </svg>
  ),
  Browser: ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
...
export const INSTALLED_APPS: AppConfig[] = [
  { id: AppID.Chat, name: 'Message', icon: 'Chat', color: 'bg-gradient-to-br from-blue-400 to-indigo-500' },
  { id: AppID.CheckPhone, name: '查手机', icon: 'CheckPhone', color: 'bg-gradient-to-br from-violet-400 to-purple-500' },
  { id: AppID.Schedule, name: '时光契约', icon: 'Schedule', color: 'bg-gradient-to-br from-cyan-400 to-blue-500' },
  { id: AppID.Journal, name: '交换日记', icon: 'Journal', color: 'bg-gradient-to-br from-amber-300 to-orange-400' },
  { id: AppID.Date, name: '见面', icon: 'Date', color: 'bg-gradient-to-br from-pink-400 to-rose-500' },
  { id: AppID.Gallery, name: '相册', icon: 'Gallery', color: 'bg-gradient-to-br from-orange-300 to-amber-500' },
  { id: AppID.ThemeMaker, name: '气泡工坊', icon: 'ThemeMaker', color: 'bg-gradient-to-br from-purple-400 to-fuchsia-500' },
...
// Dock 快捷栏
export const DOCK_APPS = [AppID.Chat, AppID.CheckPhone, AppID.Journal, AppID.Settings];
