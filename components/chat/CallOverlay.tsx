        ...
        <>
            ...
            <div className="fixed inset-0 z-[180] bg-[#0d1117] text-white flex flex-col">
                ...
                {showSettings && (
                    ...
                    >
                        <div
                            className="w-full max-w-sm rounded-2xl bg-[#0f172a] border border-white/10 shadow-2xl p-5 space-y-4"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="flex-1 bg-white/10 rounded-lg px-3 py-2 text-sm outline-none text-white"
                                    />
