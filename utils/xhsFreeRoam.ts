...
import { CharacterProfile, UserProfile, XhsActivityRecord, XhsFreeRoamSession, APIConfig } from '../types';
...
const handleViewDetail = async (
    ...
    const contextNote = contextNotes.find(n => (n.noteId || n.note_id || n.id) === noteId);
...
export const XhsFreeRoamEngine = {
    ...
    run: async (
        ...
        try {
            ...
            if (!decision) throw new Error('角色决策解析失败');
